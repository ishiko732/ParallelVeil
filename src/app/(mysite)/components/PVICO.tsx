export default function PVICO({ className }: { className?: string }) {
  return (
    <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
      <svg
        ...
        viewBox="0 0 24 24"
        className={[
          "p-0.5 dark:bg-blue-500 dark:fill-white dark:rounded-full",
          className,
        ].join(" ")}
      >
      ...
      <span className="ml-3 text-xl dark:text-white">Parallel Veil</span>
    </a>
  );
}
